        ...
        var initializeAreas = function(){
            var list = new Entities.Areas([
                ...
                },
                {
                    ...
                    url: "http://www.quickmobile.com/",
                    urltitle: "http://www.quickmobile.com/ (client facing site)",
                    content: "QuickMobile needed a significant overhaul of thier javascript best practices and codebase when I started working fulltime for this Vancouver based shop. From folder structures of css code to decisions about what design patterns to follow for the sites JS, major decisions and updates were required. We're in the process of bring online a new Backbone/Marionette/RequireJS flavoured framework (which I am spearheading on the design and implementation fronts) to handle all of our javascript, along with using tools like bower and grunt.",
                    images: [
                        {
                            src: 'images/work/10.1.jpg',
                            alt: 'QuickMobile Inc Image 1'
                ...
                },
                {
                    id: 11,
                    title: "Mobidia",
                    url: "http://www.mobidia.com/",
                    urltitle: "http://www.mobidia.com/ (not the dashboard I built)",
                    content: "Mobidia had a singlepage webapp dashboard built from vanilla javascript (and jQuery) that functioned in a browser, but from a code organization standard, was completely haphazard. I was brought it to basically rebuild the dashboard in a way that would allow other developers to extend ony my work and make adding new features to the analytics dashboard much easier. So using Backbone/Marionette and browserify, along with gulp and LESS, I did this following sound MVC principles. The site was a success, but the company was bought by the Chinese, my webapp was phased out due to the buying companies preference for doing most rendering with PHP and my contract was ended early. They offered me a spot in China, but that was a bit more than I was willing to take on, and I decided to move on to something else here in Vancouver.",
                    images: [
                        {
                            src: 'images/work/11.1.jpg',
                            alt: 'QuickMobile Inc Image 1'
                        },
                        {
                ...
                },
                {
                    ...
                    images: [
                        {
                            src: 'images/work/14.1.png',
                            alt: 'Timeline Longform Image 1'
                        },
                        {
                            src: 'images/work/14.2.png',
                            alt: 'Timeline Longform Image 2'
                        },
                        {
                            src: 'images/work/14.3.png',
                            alt: 'Timeline Longform Image 3'
                        },
                        {
                            src: 'images/work/14.4.png',
